...
import database
from common import config, event_listener, hybrid_check, loop, pages_view, parse_duration

class NoHelpForumChannelError(app_commands.CheckFailure):
  pass
...
@app_commands.command(description='Wyświetla najbardziej pomocnych użytkowników w ostatnim czasie')
