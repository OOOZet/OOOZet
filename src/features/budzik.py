...
from common import config, event_listener, hybrid_check, loop, pages_view

lock = asyncio.Lock()

class NoBudzikRolesError(app_commands.CheckFailure):
  pass
...
@app_commands.command(name='budzik', description='Wyświetla najszybszych pingujących w ostatnim czasie')
@check_budzik_roles
